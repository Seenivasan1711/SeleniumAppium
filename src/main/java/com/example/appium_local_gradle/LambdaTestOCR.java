...
public class LambdaTestOCR {
    ...
    private static DesiredCapabilities getDesiredCapabilities() {
        ...
        capabilities.setCapability("app", "lt://APP10160451051731900611881218");
        capabilities.setCapability("build", "Local Appium dev check TE-22277");
        capabilities.setCapability("name", "rwbraid");
    ...
    private static void executionForTE19487() {
        ...
        takeScreenshot();
        clickOnElement(loginButtonXpath);
